...
第3章では、JSONの構文解析器を記述することを通して、構文解析のやり方を学びました。構文解析器についても、PEG型の構文解析器および字句解析器を使った2通りを作ってみることで、構文解析器といってもいろいろな書き方があるのがわかってもらえたのではないかと思います。
...
\begin{itemize}
\item
  \textbf{構文解析器の実装}：第5章以降で学ぶさまざまな構文解析アルゴリズムの基礎
\item
