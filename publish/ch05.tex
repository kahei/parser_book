...
package com.github.parser_book.calculator;
...
import com.github.parser_book.calculator.Calculator;
import java.io.*;
...
grammar PetitXML;
@parser::header {
    import static com.github.parser_book.ch5.PetitXML.*;
    import java.util.*;
}
...
interface JParser<R> {
    ...
    default <T> JParser<T> map(Function<R, T> f) {
        return (input) -> {
            ...
            return new Result<>(
                f.apply(result.value()), result.rest()); // (1)
        };
    }
}
\end{codescreen}
